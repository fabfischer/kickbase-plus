                      ...
                      <tr v-if="hasOffer(player)">
                        ...
                        <td>
                          ...
                          >
                            ...
                            <v-chip class="ma-2" text-color="white" :color="(getPercent(offer, player.marketValue) > minPercent) ? 'green' : 'red'">
                        ...
                        <td colspan="2">
                          <table class="subtable">
                            <tr>
                              ...
                              <td>
                                <v-chip outlined :class="{'green':(getDiffPurchasePrice(player) > 0), 'red':(getDiffPurchasePrice(player) < 0)}">
    ...
    setPlayers: function(data) {
      ...
      if (data.players && data.players.length) {
        data.players.forEach((player) => {
          if (player.userId && player.userId == this.getSelf) {
